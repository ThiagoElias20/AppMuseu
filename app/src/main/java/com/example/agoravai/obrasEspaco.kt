...
class obrasEspaco : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_obras_espaco)
        ...
        val add = findViewById<Button>(R.id.add_obra_btn)
        val editar = findViewById<Button>(R.id.edit_obra_btn)
        ...
        editar.setOnClickListener {
            val intent = Intent(this,edicaoObra::class.java)
            startActivity(intent)
        }
    }
}